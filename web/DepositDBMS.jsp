    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                String depositquerycustomer = "insert into " + accountno + " values(?,?,?,?,?,?,?);";
                PreparedStatement pst1 = con.prepareStatement(depositquerycustomer);
        ...
        <div class="receipt">
            <div class="row">
                <div class="child"><p>Deposited to account:</p></div>
            ...
            <div class="row">
                <div class="child"><p>Amount Deposited:</p></div>
