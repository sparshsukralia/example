<html>
    ...
    <body>
        ...
        <form action="ForgetPasswordDBMS.jsp" method="post">
            <div class="formBlock">
                <div class="child"><p>Enter Account Number</p></div>
                <div class="child"><input type="text" name="accountno"></div>
            </div>
            <div class="formBlock">
                <div class="child"><p>Select Security Question</p></div>
            ...
            <div class="formBlock">
                <div class="child"><p>Enter Answer</p></div>
                <div class="child"><input type="text" name="txt1"></div>
            </div>
            <div class="formBlock">
                <button type="submit" name="b1" value="Recover">Recover</button>
            </div>
        </form>
        </div>
    </body>
