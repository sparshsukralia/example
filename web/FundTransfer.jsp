...
<html>
    ...
    <body>
        ...
        <form action="FundTransferDBMS.jsp" method="post">
            <div class="formBlock">
                <div class="child"><p>Account To</p></div>
                <div class="child"><input type="text" name="accountto"></div>
            </div>
            <div class="formBlock">
            ...
            <div class="formBlock">
                <div class="child"><p>Amount</p></div>
                <div class="child"><input type="text" name="amount"></div>
            </div>
            <div class="formBlock">
                <button type="submit" name="b1">Transfer Now</button>
